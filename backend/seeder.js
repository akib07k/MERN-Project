  ...
  try {
    ...
    const sampleProducts = [
      // Mobiles (5 existing + 4 new = 9)
      {
        ...
        brand: 'Apple', category: 'Mobiles', price: 999.99, countInStock: 7, rating: 4.8, numReviews: 8, user: adminUser,
      },
      {
        name: 'Samsung Galaxy S24 Ultra',
        image: 'https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=400',
        description: '200MP camera, built-in S Pen, 6.8" Dynamic AMOLED 2X display, AI features.',
        brand: 'Samsung', category: 'Mobiles', price: 1199.99, countInStock: 5, rating: 4.7, numReviews: 22, user: adminUser,
      },
      {
        name: 'OnePlus 12 5G',
        image: 'https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?w=400',
        description: 'Snapdragon 8 Gen 3, 50MP triple camera, 100W SUPERVOOC charging.',
        brand: 'OnePlus', category: 'Mobiles', price: 699.99, countInStock: 10, rating: 4.6, numReviews: 15, user: adminUser,
      },
      {
        ...
        brand: 'Google', category: 'Mobiles', price: 899.99, countInStock: 8, rating: 4.5, numReviews: 14, user: adminUser,
      },
      {
        name: 'Xiaomi 14 Ultra',
        image: 'https://images.unsplash.com/photo-1598327105666-5b89351aff97?w=400',
        description: 'Leica Summilux optical lens, WQHD+ dynamic 1-120Hz AMOLED display.',
        brand: 'Xiaomi', category: 'Mobiles', price: 949.99, countInStock: 6, rating: 4.4, numReviews: 9, user: adminUser,
      },
      {
        ...
        brand: 'Nothing', category: 'Mobiles', price: 599.99, countInStock: 12, rating: 4.3, numReviews: 18, user: adminUser,
      },
      {
        ...
        brand: 'Motorola', category: 'Mobiles', price: 449.99, countInStock: 15, rating: 4.2, numReviews: 11, user: adminUser,
      },
      {
        ...
        brand: 'Asus', category: 'Mobiles', price: 1099.99, countInStock: 4, rating: 4.9, numReviews: 7, user: adminUser,
      },
      {
        ...
        brand: 'Sony', category: 'Mobiles', price: 1299.99, countInStock: 3, rating: 4.6, numReviews: 5, user: adminUser,
      },
      // Electronics (6 existing + 2 new = 8)
      {
        ...
        brand: 'AudioTech', category: 'Electronics', price: 189.99, countInStock: 10, rating: 4.5, numReviews: 12, user: adminUser,
      },
      {
        name: 'Sony Playstation 5 Slim',
        image: 'https://images.unsplash.com/photo-1606813907291-d86efa9b94db?w=400',
        description: 'The PS5 console unleashes new gaming possibilities with ultra-high-speed SSD.',
        brand: 'Sony', category: 'Electronics', price: 449.99, countInStock: 5, rating: 5, numReviews: 12, user: adminUser,
      },
      {
        name: 'Advanced Smart Watch',
        image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400',
        description: 'Modern smartwatch with health monitoring, GPS, and 7-day battery life.',
        brand: 'TechGear', category: 'Electronics', price: 249.99, countInStock: 8, rating: 4.6, numReviews: 24, user: adminUser,
      },
      {
        ...
        brand: 'Sony', category: 'Electronics', price: 349.99, countInStock: 6, rating: 4.9, numReviews: 31, user: adminUser,
      },
      {
        name: 'Dell 27" 4K Monitor',
        image: 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?w=400',
        description: '4K UHD IPS panel, 60Hz, USB-C, perfect for creative professionals.',
        brand: 'Dell', category: 'Electronics', price: 499.99, countInStock: 4, rating: 4.5, numReviews: 9, user: adminUser,
      },
      {
        ...
        brand: 'Apple', category: 'Electronics', price: 1599.99, countInStock: 3, rating: 4.9, numReviews: 18, user: adminUser,
      },
      {
        name: 'Mechanical Gaming Keyboard',
        image: 'https://images.unsplash.com/photo-1511467687858-23d96c32e4ae?w=400',
        description: 'RGB mechanical keyboard with blue switches for precise gaming.',
        brand: 'GameMaster', category: 'Electronics', price: 89.99, countInStock: 15, rating: 4.7, numReviews: 22, user: adminUser,
      },
      {
        ...
        brand: 'LogiTech', category: 'Electronics', price: 69.99, countInStock: 20, rating: 4.6, numReviews: 45, user: adminUser,
      },
      // Fashion (4 existing + 4 new = 8)
      {
        ...
        brand: 'UrbanStyle', category: 'Fashion', price: 59.99, countInStock: 15, rating: 4.8, numReviews: 5, user: adminUser,
      },
      {
        ...
        brand: 'DenimCo', category: 'Fashion', price: 79.99, countInStock: 20, rating: 4.3, numReviews: 14, user: adminUser,
      },
      {
        name: 'Women\'s Floral Sundress',
        image: 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?w=400',
        description: 'Lightweight floral print sundress, perfect for summer outings.',
        brand: 'Florals', category: 'Fashion', price: 49.99, countInStock: 18, rating: 4.6, numReviews: 20, user: adminUser,
      },
      {
        ...
        brand: 'Heritage', category: 'Fashion', price: 149.99, countInStock: 10, rating: 4.7, numReviews: 12, user: adminUser,
      },
      {
        ...
        brand: 'UrbanStep', category: 'Fashion', price: 65.99, countInStock: 25, rating: 4.4, numReviews: 38, user: adminUser,
      },
      {
        name: 'Silk Evening Gown',
        image: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?w=400',
        description: 'Stunning silk gown for formal evening events, elegant and luxurious.',
        brand: 'LuxeFashion', category: 'Fashion', price: 299.99, countInStock: 5, rating: 4.9, numReviews: 10, user: adminUser,
      },
      {
        ...
        brand: 'Heritage', category: 'Fashion', price: 189.99, countInStock: 12, rating: 4.7, numReviews: 15, user: adminUser,
      },
      {
        name: 'Designer Sunglasses',
        image: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=400',
        description: 'Premium polarized sunglasses with UV protection and designer frames.',
        brand: 'StyleView', category: 'Fashion', price: 120.00, countInStock: 30, rating: 4.6, numReviews: 24, user: adminUser,
      },
      // Beauty (3 existing + 5 new = 8)
      {
        ...
        brand: 'GlowUp', category: 'Beauty', price: 34.99, countInStock: 30, rating: 4.7, numReviews: 42, user: adminUser,
      },
      {
        ...
        brand: 'LuxeScent', category: 'Beauty', price: 89.99, countInStock: 12, rating: 4.8, numReviews: 16, user: adminUser,
      },
      {
        ...
        brand: 'StylePro', category: 'Beauty', price: 69.99, countInStock: 9, rating: 4.4, numReviews: 11, user: adminUser,
      },
      {
        ...
        brand: 'PureSkin', category: 'Beauty', price: 24.99, countInStock: 40, rating: 4.5, numReviews: 55, user: adminUser,
      },
      {
        ...
        brand: 'GlamLook', category: 'Beauty', price: 19.99, countInStock: 50, rating: 4.8, numReviews: 120, user: adminUser,
      },
      {
        name: 'Organic Face Oil',
        image: 'https://images.unsplash.com/photo-1571781926291-c477ebfd024b?w=400',
        description: '100% pure organic face oil for nocturnal repair and deep hydration.',
        brand: 'NaturePure', category: 'Beauty', price: 45.00, countInStock: 20, rating: 4.7, numReviews: 34, user: adminUser,
      },
      {
        ...
        brand: 'Artistry', category: 'Beauty', price: 39.99, countInStock: 15, rating: 4.6, numReviews: 28, user: adminUser,
      },
      {
        ...
        brand: 'GlowUp', category: 'Beauty', price: 15.99, countInStock: 60, rating: 4.5, numReviews: 89, user: adminUser,
      },
      // Toys (8 existing)
      {
        ...
        brand: 'LEGO', category: 'Toys', price: 59.99, countInStock: 16, rating: 4.9, numReviews: 35, user: adminUser,
      },
      {
        ...
        brand: 'ToyZone', category: 'Toys', price: 49.99, countInStock: 14, rating: 4.4, numReviews: 22, user: adminUser,
      },
      {
        ...
        brand: 'SoftToys', category: 'Toys', price: 29.99, countInStock: 25, rating: 4.8, numReviews: 15, user: adminUser,
      },
      {
        ...
        brand: 'ExpressTracks', category: 'Toys', price: 79.99, countInStock: 8, rating: 4.6, numReviews: 10, user: adminUser,
      },
      {
        ...
        brand: 'SmartKids', category: 'Toys', price: 44.99, countInStock: 12, rating: 4.7, numReviews: 28, user: adminUser,
      },
      {
        ...
        brand: 'EcoPlay', category: 'Toys', price: 34.99, countInStock: 20, rating: 4.5, numReviews: 12, user: adminUser,
      },
      {
        ...
        brand: 'ArtPlay', category: 'Toys', price: 39.99, countInStock: 15, rating: 4.3, numReviews: 18, user: adminUser,
      },
      {
        ...
        brand: 'DinoWorld', category: 'Toys', price: 19.99, countInStock: 30, rating: 4.6, numReviews: 40, user: adminUser,
      },
      // Books (3 existing + 5 new = 8)
      {
        ...
        brand: 'FictionPress', category: 'Books', price: 19.99, countInStock: 50, rating: 4.5, numReviews: 45, user: adminUser,
      },
      {
        name: 'Atomic Habits - James Clear',
        image: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=400',
        description: 'An easy and proven way to build good habits and break bad ones.',
        brand: 'Penguin Random House', category: 'Books', price: 14.99, countInStock: 60, rating: 4.9, numReviews: 88, user: adminUser,
      },
      {
        name: 'The Psychology of Money',
        image: 'https://images.unsplash.com/photo-1553729459-efe14ef6055d?w=400',
        description: 'Timeless lessons on wealth, greed, and happiness by Morgan Housel.',
        brand: 'Harriman House', category: 'Books', price: 16.99, countInStock: 40, rating: 4.8, numReviews: 52, user: adminUser,
      },
      {
        name: 'The Alchemist',
        image: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=400',
        description: 'A global phenomenon, Paulo Coelho\'s masterpiece about following your dreams.',
        brand: 'HarperCollins', category: 'Books', price: 12.99, countInStock: 100, rating: 4.9, numReviews: 210, user: adminUser,
      },
      {
        ...
        brand: 'FSG', category: 'Books', price: 18.50, countInStock: 35, rating: 4.7, numReviews: 45, user: adminUser,
      },
      {
        ...
        brand: 'Random House', category: 'Books', price: 15.99, countInStock: 45, rating: 4.8, numReviews: 67, user: adminUser,
      },
      {
        name: 'Deep Work - Cal Newport',
        image: '/uploads/deep_work_cal_newport_book_cover_stylized_1773680129123.png',
        description: 'Rules for focused success in a distracted world.',
        brand: 'Grand Central', category: 'Books', price: 13.99, countInStock: 55, rating: 4.6, numReviews: 32, user: adminUser,
      },
      {
        ...
        brand: 'Harper', category: 'Books', price: 21.99, countInStock: 70, rating: 4.9, numReviews: 145, user: adminUser,
      },
      // Furniture (8 new)
      {
        ...
        brand: 'HomeLuxe', category: 'Furniture', price: 899.00, countInStock: 5, rating: 4.8, numReviews: 12, user: adminUser,
      },
      {
        ...
        brand: 'RetroGrain', category: 'Furniture', price: 349.99, countInStock: 10, rating: 4.7, numReviews: 8, user: adminUser,
      },
      {
        ...
        brand: 'NordicWood', category: 'Furniture', price: 599.00, countInStock: 4, rating: 4.6, numReviews: 15, user: adminUser,
      },
      {
        ...
        brand: 'ForgeHome', category: 'Furniture', price: 229.99, countInStock: 12, rating: 4.5, numReviews: 20, user: adminUser,
      },
      {
        ...
        brand: 'ComfortSleep', category: 'Furniture', price: 1199.00, countInStock: 3, rating: 4.9, numReviews: 6, user: adminUser,
      },
      {
        ...
        brand: 'Steller', category: 'Furniture', price: 449.00, countInStock: 8, rating: 4.7, numReviews: 14, user: adminUser,
      },
      {
        name: 'Office Swivel Chair',
        image: 'https://images.unsplash.com/photo-1580480055273-228ff5388ef8?w=400',
        description: 'Ergonomic office chair with breathable mesh and lumbar support.',
        brand: 'WorkPro', category: 'Furniture', price: 199.99, countInStock: 20, rating: 4.4, numReviews: 45, user: adminUser,
      },
      {
        name: 'Outdoor Patio Set',
        image: 'https://images.unsplash.com/photo-1506439773649-6e0eb8cfb237?w=400',
        description: 'Weather-resistant rattan patio set including two chairs and a side table.',
        brand: 'GardenJoy', category: 'Furniture', price: 399.00, countInStock: 6, rating: 4.6, numReviews: 11, user: adminUser,
      }
    ];
